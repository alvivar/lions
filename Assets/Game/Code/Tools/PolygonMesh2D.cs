...
// http://github.com/NotWoods/unity-polygon-2d-editor
...
public class PolygonMesh2D : MonoBehaviour
{
    ...
    int pathIndex = 0; // The index of the polygon path to use for the mesh.
    public float zPosition = 0f; // The Z position for the generated mesh.
